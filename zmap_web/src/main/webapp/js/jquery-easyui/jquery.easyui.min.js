...
if($("#needAttrWidth").length > 0){
	return {width:$(p).attr("width"),height:$(p).height()};
}else{
	return {width:$(p).width(),height:$(p).height()};
}
...
if(_81.pageList[i] == $.fn.pagination.defaults.selectMax){
	$("<option></option>").text($.fn.pagination.defaults.quanbu).val(_81.pageList[i]).appendTo(ps);
}else{
	$("<option></option>").text(_81.pageList[i]).val(_81.pageList[i]).appendTo(ps);
}
...
$("<div isChecked=\"false\" class=\"datagrid-header-allCheck\">"+$.fn.datagrid.defaults.allCheck+"</div>").appendTo(td);
}else{
if(col.field){
td.attr("field",col.field);
...
//pengsy 2013-11-19
_4df.find(".datagrid-header-allCheck").unbind(".datagrid").bind("click.datagrid",function(e){
...
//$(_630).html(_634.join("")); //chenyh 2013-11-14
$(_630)[0].innerHTML = _634.join("");
...
if(data && typeof data.length=="number"&&typeof data.splice=="function"){
...
// 2013-11-29 wangxz begin for var _7ed=_7ec.indexOf(_7ea+"");
var _7ed=-1;
...
//wangzw 2014-07-09
var _qkdate = $("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(opts.cleanText).appendTo(_858);

_qkdate.click(function(){
